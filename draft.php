...
<div class="main">
 ...
 Description: <input type="text" name="aname" id="desc" required><br><br>
  ...
  <!----------------------------------------------------------------------------------->
  <hr>
<p><center>uploaded image list</center></p>
  <div>
...
<?php 
  $sql="SELECT `name`, `description`, `image` from seller_image";
  ...
  <tr>
     ...
     <td><img src= " <?php echo $row['image'];?>"class="img-fluid product-image" alt="" width=50 px; height=50px;></td>
