...
$category=($_POST['name']);
$duplicate=mysqli_query($con,"SELECT * FROM category WHERE category='$category'");
...
/*if(isset($_GET['category_id']) && $_GET['category_id'!='']){
 $id=($_GET['category_id']); 
 $res=$sql=mysqli_query($con,"SELECT * FROM category where category_id='$id'");
...
<div class="sidenav">
  ...
  <a href="reg.php">logout</a>
    ...
    <div style="margin-left:15%;">
      <h2>Categories</h2>
      <h3><a href="addCategories.php"> Add categories</a></h3>
